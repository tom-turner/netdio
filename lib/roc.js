...
let poisoning = true 
  ? '--poisoning' 
  : ''
let driver = platform.driver() ? `${platform.driver()}` : ''
let inputDevice = platform.inputDevice() ? `${platform.inputDevice()}` : ''
let outputDevice = platform.outputDevice() ? `${platform.outputDevice()}` : ''
