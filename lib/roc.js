...
class Roc {
  constructor(config) {
    ...
    setInterval( () => {
      if ( this.storedChildProcesses() !== this.childProcesses ) {
        fs.writeFileSync('config/runningprocesses.json', JSON.stringify(this.childProcesses)), (err) => {
