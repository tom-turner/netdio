...
class Spotify {
	...
	startAndKeepUp(callback){
		...
		this.spotify = exec('~/librespot/target/release/librespot -n Duckado-Connect --enable-volume-normalisation --normalisation-pregain "-3" --backend alsa --device librespot --format S16')
