...
class Spotify {
	...
	startAndKeepUp(callback){
		...
		this.spotify = exec(`~/librespot/target/release/librespot -n Duckado-Connect -b 160 --initial-volume 100 --enable-volume-normalisation --normalisation-pregain 0 --device hw:Loopback,0`)
